...
namespace EL_bookstore
{
    public partial class details : Inherited
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (connection)
            {
                SqlCommand myCommand = new SqlCommand("insertShopCart", connection);
                myCommand.CommandType = CommandType.StoredProcedure;
                myCommand.CommandText = "InsertShopCart";
                ...
                parQty.Value = ((TextBox)FormView1.FindControl("TextBoxQty")).Text;
